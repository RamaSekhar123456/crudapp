 ...
 class ProductProvider extends Component {
    ...
    onSave = (id) => {
        if (id!=='') {
            ...
            Record['title'] = this.state.udpateEdit[1];
            Record['info'] = this.state.udpateEdit[2];
            Record['price'] = this.state.udpateEdit[3];
            Record['company'] = this.state.udpateEdit[4];
            this.setState({
            ...
            const id = MaxId + 1;
            const newArr = [];
            newArr['title'] = this.state.udpateEdit[1];
            newArr['info'] = this.state.udpateEdit[2];
            newArr['price'] = this.state.udpateEdit[3];
            newArr['company'] = this.state.udpateEdit[4];
            this.setState({
